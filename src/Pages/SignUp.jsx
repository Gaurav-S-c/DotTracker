...
import {Goal,Mail,Lock,Eye,User } from "lucide-react"
                ...
                <form onSubmit={handleSubmit} className="mt-7">
                    <div className="mb-3">
                        ...
                        <div className="relative">
                            ...
                            <input type="text" placeholder="Enter your Name" className="w-full border-2 border-[#EEEEEE] focus:outline-none rounded-xl py-3 pl-10 pr-5 focus:ring-2 focus:ring-[#bdbdbd] " required/>
                        </div>
                    </div>
                    <div className="mb-3">
